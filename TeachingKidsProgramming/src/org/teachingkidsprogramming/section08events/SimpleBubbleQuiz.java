      ...
      MouseRightClickListener
{
  ...
  public void question2()
  {
    ...
    new Text("Single!").setPenColor(Yellows.Yellow).setTopLeft(155, 135).addTo(Tortoise.getBackgroundWindow());
  }
  @Override
  ...
  public void question4()
  {
    ...
    new Text("Home Run!").setPenColor(Greens.LimeGreen).setTopLeft(105, 235).addTo(Tortoise.getBackgroundWindow());
  }
